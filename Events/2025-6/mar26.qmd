...
`{r} str_to_title(as.english(num_teams))` teams took part. The scores of the top four members of each time was summed, except Orion and Linwood, which had just two archers on their team.
