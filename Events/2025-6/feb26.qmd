...
`{r} str_to_title(as.english(num_teams))` teams took part. The scores of the top four members of each time was summed. Note that hits and golds were not recorded for this event.
