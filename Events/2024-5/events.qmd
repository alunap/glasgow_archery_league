...
[Detailed results](2024-5/east_kilbride_oct.qmd)
...
[Detailed results](2024-5/coatbridge_nov.qmd)
...
[Detailed results](2024-5/coatbridge_dec.qmd)
...
[Detailed results](2024-5/east_kilbride_jan.qmd)
...
[Detailed results](2024-5/coatbridge_mar.qmd)
...
[Detailed results](2024-5/coatbridge_mar22.qmd)

## Progress charts

```{r}
all_archers <- load_all_archer_scores()
scores <- filter(all_archers, score > 0, between(event_date, as.Date('2024-10-01'), as.Date('2025-03-23')))
```
